...
def approval_program():
    ...
    def delete_app():
        ...
        # Ideally this isn't how you would want to handle deleting a contract
        # you would most likely only want this app deleted if the milestone has not stared or it has ended
        # but I just implement it this way because I want to clear the amount of apps I have on the deployer address
